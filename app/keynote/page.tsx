      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center animate-on-scroll opacity-0 translate-y-8">
            ...
            <div className="flex items-center justify-center space-x-8 text-gray-400 mb-12">
            ...
            <div className="aspect-video bg-gray-900 rounded-3xl overflow-hidden shadow-2xl">
              <div className="relative w-full h-full bg-gradient-to-br from-blue-900 to-purple-900 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-24 h-24 bg-white/20 rounded-full flex items-center justify-center mb-6 mx-auto hover:bg-white/30 transition-colors cursor-pointer hover:scale-110 transform duration-300">
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-300">Quantum-secured transactions</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                    <span className="text-gray-300">Sub-second global transfers</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                    <span className="text-gray-300">AI fraud prevention</span>
                  </div>
                </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-300">Advanced reasoning engine</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                    <span className="text-gray-300">Multi-modal understanding</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
            ...
            <Card className="bg-gray-900 border-gray-800 rounded-3xl overflow-hidden hover:scale-105 transition-all duration-500 animate-on-scroll opacity-0 translate-y-8 delay-400">
              <CardContent className="p-8">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                    <span className="text-gray-300">SDK for all platforms</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-on-scroll opacity-0 translate-y-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Button className="bg-white text-black hover:bg-gray-100 p-6 rounded-2xl flex flex-col items-center space-y-3 hover:scale-105 transition-all duration-300">
                <Download className="w-8 h-8" />
                <span className="font-semibold">Keynote Slides</span>
                <span className="text-sm text-gray-600">PDF • 15.2 MB</span>
              </Button>
              <Button className="bg-white text-black hover:bg-gray-100 p-6 rounded-2xl flex flex-col items-center space-y-3 hover:scale-105 transition-all duration-300">
                <Download className="w-8 h-8" />
                <span className="font-semibold">Press Kit</span>
                <span className="text-sm text-gray-600">ZIP • 45.8 MB</span>
              </Button>
              <Button className="bg-white text-black hover:bg-gray-100 p-6 rounded-2xl flex flex-col items-center space-y-3 hover:scale-105 transition-all duration-300">
                <Download className="w-8 h-8" />
                <span className="font-semibold">Developer Guide</span>
                <span className="text-sm text-gray-600">PDF • 8.4 MB</span>
              </Button>
            </div>
          </div>
        </div>
